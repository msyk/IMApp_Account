    ...
    [
        [
            ...
            'calculation' => [
                ...
                ['field' => "item_total8_calc", 'expression' => "sum(detail_list@item_price8_calc)",],
                ['field' => "tax_total8_calc", 'expression' => "sum(detail_list@tax_price8_calc)",],
                ['field' => "net_total8_calc", 'expression' => "sum(detail_list@net_price8_calc)",],
                ['field' => "item_total10_calc", 'expression' => "sum(detail_list@item_price10_calc)",],
                ['field' => "tax_total10_calc", 'expression' => "sum(detail_list@tax_price10_calc)",],
                ['field' => "net_total10_calc", 'expression' => "sum(detail_list@net_price10_calc)",],
            ],
            'file-upload' => [
                ['container' => 'S3',],
            ],
